...
*This is actually a disconnected fork from jasperproject/jasper-client. Mostly because I have no current plans to merge it back to master and I want my local modifications to count as contributions.*
